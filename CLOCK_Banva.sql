...
Create table Mota(
	MaMoTa INT IDENTITY(1,1) primary key,
...
Create table CHITIETDONDATHANG(
	...
	ConStraint PK_MaDH_CT Foreign key (MaDH) references DongHo on update cascade,
						...
						----- BANG TAI KHOAN -----
GO
INSERT [dbo].[TaiKhoan] ( [TenDangNhap], [MatKhau], [Permison]) VALUES ( N'admin', N'admin',1)
INSERT [dbo].[TaiKhoan] ( [TenDangNhap], [MatKhau], [Permison]) VALUES ( N'khoi', N'khoi',0)
INSERT [dbo].[TaiKhoan] ( [TenDangNhap], [MatKhau], [Permison]) VALUES ( N'quang', N'123',0)
INSERT [dbo].[TaiKhoan] ( [TenDangNhap], [MatKhau], [Permison]) VALUES ( N'tuan', N'123',0)
INSERT [dbo].[TaiKhoan] ( [TenDangNhap], [MatKhau], [Permison]) VALUES ( N'truong', N'123',0);
GO
						------ BANG ADMIN -------
GO
